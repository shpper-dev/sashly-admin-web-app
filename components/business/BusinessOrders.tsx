...
export default function BusinessOrders({ orders, loading }: BusinessOrdersProps) {
  ...
  const displayedOrders = activeFilter === "Active" ? activeOrders : allOrders;
      ...
      <div className="grid grid-cols-2 gap-4 mt-8">
        ...
        <div className="flex flex-col gap-2">
          ...
          {readyForPickup.length === 0 ? (
            <EmptyStateCard title="Ready for Pickup" description="No orders awaiting pickup" icon={ClockCheck} />
          ) : (
            <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          ...
          {readyForDelivery.length === 0 ? (
            <EmptyStateCard title="Ready for Delivery" description="No orders ready to deliver" icon={ClockIcon} />
          ) : (
            <div className="flex flex-col gap-2">
