            ...
            <thead className="border-b border-slate-200">
              <tr>
                {orderHeadings.map((heading) => (
                  <th
                    key={heading.id}
                    className="text-left first:pl-4 px-2 py-3 text-sm font-semibold text-slate-500 "
                  >
                    {heading.title}
                  </th>
                ))}
              ...
              {rows.map((row) => (
                ...
                >
                  {orderHeadings.map((heading) => (
                    <td
                      key={heading.id}
                      className="first:pl-4 px-2 py-4 text-sm text-slate-700"
                    >
