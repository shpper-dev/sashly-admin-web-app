...
import { Banknote, Clock, RotateCcw, Wallet, ArrowRight, WalletIcon, Loader2 } from 'lucide-react'
          ...
          <div className="rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
            ...
            <div className="flex items-center justify-between px-6 py-3.5 border-t border-slate-100 bg-slate-50">
              <span className="text-xs text-slate-400 font-medium">
                Showing {activeRows.length} {activeTab === "payout" ? "payout" : "top-up"} request{activeRows.length !== 1 ? "s" : ""}
              </span>
              {/* Placeholder — wire up once a dedicated "all requests" view/pagination exists */}
